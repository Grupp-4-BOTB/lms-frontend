...
export default function RegisterForm() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // ==========================================
      // UTÖKAD LOGIK: KOPPLING TILL VERIFIKATIONSTJÄNSTEN
      // ==========================================
      if (response.ok) {
        ...
        // URL-encodar e-posten så att kollegans sida kan hämta upp den och veta vem som verifieras.
        router.push(`/verification?email=${encodeURIComponent(email)}`);
        // New Code for Verication End
      }
      //  New Code
      else {
